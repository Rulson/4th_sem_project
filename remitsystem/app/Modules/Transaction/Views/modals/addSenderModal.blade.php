...
<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel">Add Sender</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
    </button>
</div>

{!!Form::open(array('route' => ['sender.store'], 'id' => 'add-sender', 'enctype'=>'multipart/form-data','method' => 'post'))!!}
...
<div class="modal-footer">
    ...
    <button type="submit" id="add-senderPopup" class="btn btn-primary">Save</button>
</div>
{!!Form::close()!!}
...
<script>
    ...
    /*  $("#sender-street").on("keyup",function(){
          alert('2');
      });*/

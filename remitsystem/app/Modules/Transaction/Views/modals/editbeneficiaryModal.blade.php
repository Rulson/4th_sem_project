<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel">Edit Beneficiary</h4>
...
{!!Form::model($beneficiary, array('route' => array('beneficiary.update', $beneficiary->beneficiary_id),'id'=>'editbeneficiary', 'class' => '', 'method' => 'POST','files'=>'true'))!!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control" id="first_name"
                                       placeholder="Enter First Name" value="{{$beneficiary->first_name}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="last_name" class="form-control" id="last_name"
                                       placeholder="Enter Last Name" value="{{$beneficiary->last_name}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="number" class="form-control"
                                       id="number"
                                       placeholder="Enter Phone Number" value="{{$beneficiary->number}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" >
                                ...
                                <input type="text" name="street" class="form-control" id="street"
                                       placeholder="Enter Suburb" value="{{$beneficiary->street}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('bsb')) {{'has-error'}} @endif">
                                ...
                                <input type="text" name="bsb" class="form-control"
                                       id="bsb"
                                       placeholder="Enter Branch" value="{{$beneficiary->bsb}}">
                            </div>
                            @if($errors->has('bsb'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!!Form::select('bank_name', BankList(), $beneficiary->bankName, array('class' => 'form-control', 'id'=>'bank_name','placeholder'=>'Please Select'))!!}
                            </div>

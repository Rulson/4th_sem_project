...
@section('content')
    ...
    <div class="animated fadeIn">
        <div class="card">
            ...
            <div class="card-body">
                @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
                            <table id="onHoldTransaction" class="table table-bordered table-striped ">
                                ...
                                <tbody class="onhold-color">
                                </tbody>
                                <tfoot class="onhold-color">
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
            $('#onHoldTransaction').dataTable({

                "processing": true,
                "destroy":true,
                "serverSide": true,
                "searching":true,
                "ajax": "/transactions/getTransactionsData/7",
                'scrollX': true,
                "columns": [

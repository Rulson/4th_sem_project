...
@section('content')
    ...
    <div class="animated fadeIn">
        <div class="card">
            ...
            <div class="card-body">
                        @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
                            <table id="cancelledTransaction" class="table table-bordered table-striped ">
                                ...
                                <tbody class="cancelled-color">
                                </tbody>
                                <tfoot class="cancelled-color">
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
            $('#cancelledTransaction').dataTable({

                "processing": true,
                "destroy":true,
                "serverSide": true,
                "searching":true,
                "ajax": "/transactions/getTransactionsData/6",
                'scrollX': true,
                "columns": [

...
@section('content')
    ...
    <div class="animated fadeIn">
        <div class="card">
            ...
            <div class="card-body">
                @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
                            <table id="deliveredTransaction" class="table table-bordered table-striped ">
                                ...
                                <tr>
                                    ...
                                    <th>Client Rate</th><th>Agent Rate</th>
                                ...
                                <tbody class="delivered-color">
                                </tbody>
                                <tfoot class="delivered-color">
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
            $('#deliveredTransaction').dataTable({

                "processing": true,
                "destroy":true,
                "serverSide": true,
                "searching":true,
                "ajax": "/transactions/getTransactionsData/5",
                'scrollX': true,
                "columns": [

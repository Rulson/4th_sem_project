...
@section('breadcrumb')
    ...
    <li  class="breadcrumb-item active">Send For Collection</li>
@stop
@section('content')
    ...
    <div class="animated fadeIn">
                <div class="card">
                    ...
                    <div class="card-body">
                            @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
                                <table id="sendForCollectionTransaction" class="table table-bordered table-striped ">
                                    ...
                                    <tbody class="sendforcollection-color">
                                    </tbody>
                                    <tfoot class="sendforcollection-color">
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td></td>
...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
            $('#sendForCollectionTransaction').dataTable({

                "processing": true,
                "destroy":true,
                "serverSide": true,
                "searching":true,
                "ajax": "/transactions/getTransactionsData/3",
                'scrollX': true,
                "columns": [

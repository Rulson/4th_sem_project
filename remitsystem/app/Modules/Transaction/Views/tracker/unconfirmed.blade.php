...
@section('breadcrumb')
    ...
    <li  class="breadcrumb-item active">Unconfirmed</li>
@stop
@section('content')
   ...
   <div class="animated fadeIn">
       <div class="card">
           ...
           <div class="card-body">
               @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
                   <table id="unconfirmedTransaction" class="table table-bordered table-striped">
                       <thead>
                       <tr>
                       ...
                       <tbody class="unconfirmed-color">


                       </tbody>
                       <tfoot class="unconfirmed-color">
                       <tr>
                           <td></td>
                           <td></td>
                           <td></td>
...
@section('page-script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            @if(Auth::user()->level_id == 1 || Auth::user()->level_id == 2)
         $('#unconfirmedTransaction').dataTable({

                "processing": true,
                "destroy":true,
                "serverSide": true,
                "searching":true,
                "ajax": "/transactions/getTransactionsData/1",
             'scrollX': true,
                "columns": [

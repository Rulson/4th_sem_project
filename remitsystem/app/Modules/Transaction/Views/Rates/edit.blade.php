...
@section('content')
    ...
    <div class="animated fadeIn">
        ...
        <div class="card">
            ...
            <form method="post" action="{{route('update.rate',$rates->id)}}" class="form-horizontal">
                {{csrf_field()}}
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" step="0.01" name="exchange_rate" value="{{$rates->exchange_rate}}" class="form-control" placeholder="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" step="0.01" name="cost_rate" value="{{$rates->cost_rate}}" class="form-control" placeholder="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" step="0.01" name="agent_rate" value="{{$rates->agent_rate}}" class="form-control" placeholder="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" step="0.01" name="threshold_amount" value="{{$rates->threshold_amount}}" class="form-control" placeholder="">
